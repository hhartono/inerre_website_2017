    ...
    <div class="grey-bg"> <!-- Grey BG  -->
        ...
        <div class="container p-140-cont">
            <div class="row">
                ...
                <div class="col-md-6 pb-70">
                    <div class="post-prev-img">
                        <a href="<?php echo site_url('BlumV1/utensil_storage'); ?>"><img src="/assets/images/inerre/blum/utensil/blum_utensil_01.jpg" alt="img"></a>
                    </div>

                    <div class="post-prev-title">
                        <h3><a href="<?php echo site_url('BlumV1/utensil_storage'); ?>">BLUM ORGA-LINE UTENSIL STORAGE</a></h3>
                    </div>
