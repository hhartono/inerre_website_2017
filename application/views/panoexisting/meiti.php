                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                ...
                                <a class="button medium thin hover-dark" href="http:// <?php echo rawurlencode($GLOBALS['inerre_vr']); ?> /existing/meiti/tour.html">LANTAI 2</a><br>
                                <a class="button medium thin hover-dark" href="http:// <?php echo rawurlencode($GLOBALS['inerre_vr']); ?> /existing/meiti2/tour.html">LANTAI 3</a>
                            </div>
                        </div>
                    </div>
                </div>
