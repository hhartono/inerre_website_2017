                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                ...
                                <a class="button medium thin hover-dark" href="http://<?php echo urldecode($GLOBALS['inerre_vr_backup']); ?>/existing/irene/tour.html">see existing</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                ...
                                <a class="button medium thin hover-dark" href="http://<?php echo urldecode($GLOBALS['inerre_vr_backup']); ?>/existing/nana/tour.html">see existing</a><br>
