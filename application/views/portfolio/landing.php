...
<html>
<head>
    <title>INERRE interior - Portfolio</title>
    <meta charset=utf-8 >
    <!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=edge"><![endif]-->
    <meta name="robots" content="index, follow" >
    <meta name="keywords" content="HTML5 Template" >
    <meta name="description" content="INERRE interior - Portfolio" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                <h3><span class="bold">RD RESIDENCE</span></h3>
                                <a class="button medium thin hover-dark" href="<?php echo site_url('Portfolio/Portfolio5'); ?>">see portfolio</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                <h3><span class="bold">RN APARTMENT</span></h3>
                                <a class="button medium thin hover-dark" href="<?php echo site_url('Portfolio/Portfolio6'); ?>">see portfolio</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                <h3><span class="bold">LD RESIDENCE</span></h3>
                                <a class="button medium thin hover-dark" href="<?php echo site_url('Portfolio/Portfolio7'); ?>">see portfolio</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                <h3><span class="bold">TV RESIDENCE</span></h3>
                                <a class="button medium thin hover-dark" href="<?php echo site_url('Portfolio/Portfolio8'); ?>">see portfolio</a>
                            </div>
                        </div>
                    </div>
                </div>
