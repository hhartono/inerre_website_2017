                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text demo-buttons">
                                <h3><span class="bold">CHELSEA - DESIGN PRESENTATION</span></h3>
                                <a class="button medium thin hover-dark" href="http://18.139.219.177/pdf/chelsea/Chelsea_Presentation_19.06.2020.pdf">download PDF document</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text demo-buttons">
                                <h3><span class="bold">CHELSEA - TASIKMALAYA - LIVING & PANTRY</span></h3>
                                <a class="button medium thin hover-dark" href="http://18.139.219.177/chelseavtour2/tour.html">see 360 rendering</a>
                            </div>
                        </div>
                    </div>
                </div>
