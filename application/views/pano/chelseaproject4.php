                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text demo-buttons">
                                <h3><span class="bold">CHELSEA - DESIGN PRESENTATION - REV3</span></h3>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="cis-cont">
                            ...
                            <div class="cis-text demo-buttons">
                                <h3><span class="bold">CHELSEA - TASIKMALAYA - LIVING & PANTRY - REV3</span></h3>
                                <a class="button medium thin hover-dark" href="http://18.139.219.177/chelseavtour/tour.html">see 360 rendering</a> // FINAL
                            </div>
                        </div>
                    </div>
                </div>
