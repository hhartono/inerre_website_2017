                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="cis-cont">
                            ...
                            <div class="cis-text">
                                <h3><span class="bold">LUSIANA - KOTA BARU PARAHYANGAN - FASE 3</span></h3>
                                <a class="button medium thin hover-dark" href="<?php echo site_url('Pano/lusiana_project_3'); ?>">see project</a>
                            </div>
                        </div>
                        <div class="cis-cont">
                            <div class="cis-icon">
