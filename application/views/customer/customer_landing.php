            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php
                        ...
                        // Test output - Query Builder
                        //$query = $this->db->get('customer_table');
                        //foreach ($query->result() as $row)
                        //{
                        //    echo 'KEY = ' . $row->customer_keyword . '; ';
                        //    echo 'NAME = ' . $row->customer_name . '<br>';
                        //}

                        // Test input
                        //$sql = "INSERT INTO mytable (title, name) VALUES (".$this->db->escape($title).", ".$this->db->escape($name).")";
                        //$insert_sql = "INSERT INTO customer_table (customer_keyword, customer_name) VALUES ('Hans', 'Hans Hartono')";
                ...
                <div id="tables" class="mb-100 bs-docs-section">
                    <h4>INERRE customers</h4>
                    <table class="table table-striped mb-40">
                        <thead>
                        <tr>
                            <th><b>#</b></th>
                            <th><b>Project Keyword</b></th>
                            <th><b>Customer Name</b></th>
                            <th><b>Project Address</b></th>
                        </tr>
                        </thead>
                        <tbody>
                        ...
                        <?php
                            ...
                            foreach ($query->result() as $row)
                            {
                                $detail_url = site_url('Customer/customer_detail/' . $row->customer_keyword);

                                echo '<tr>';
                                echo '<td>' . $count . '</td>';
                                echo '<td> <a href="' . $detail_url . '">' . $row->customer_keyword . '</a></td>';
