...
class Pano extends CI_Controller {
    ...
    */
    ...
    {
        $data['rows'][0]['title'] = "WILLIAM - 360 RENDERING - KIDS BEDROOM - PHASE 3";
        $data['rows'][0]['url'] = "http://18.139.219.177/williamvtour5/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";

        $data['rows'][1]['title'] = "WILLIAM - 360 RENDERING - WET KITCHEN - PHASE 3";
        $data['rows'][1]['url'] = "http://18.139.219.177/williamvtour4/tour.html";
        $data['rows'][1]['button_title'] = "see 360 rendering";

        $data['rows'][2]['title'] = "WILLIAM - 360 RENDERING - PARENTS BEDROOM - PHASE 3";
        $data['rows'][2]['url'] = "http://18.139.219.177/williamvtour3/tour.html";
        $data['rows'][2]['button_title'] = "see 360 rendering";
    ...
    public function leny_project()
    {
        ...
        $data['rows'][1]['title'] = "LENY - FLOOR PLAN - PHASE 1";
        $data['rows'][1]['url'] = "http://18.139.219.177/pdf/leny/denah/Leny_RTU_Denah1.pdf";
        $data['rows'][1]['button_title'] = "download PDF document";
