...
class Pano extends CI_Controller {
    ...
    public function erland_project()
    {
        ...
        $data['rows'][1]['url'] = "http://18.139.219.177/pdf/erland/Erland_Presentation_18.04.2022.pdf";
        $data['rows'][1]['button_title'] = "download PDF document";
    ...
    public function regina_project()
    {
        ...
        //$data['rows'][2]['title'] = "REGINA - PRESENTATION - RTU";
        //$data['rows'][2]['url'] = "http://18.139.219.177/pdf/regina/Regina_Presentation_10.05.2022.pdf";
        //$data['rows'][2]['button_title'] = "download PDF document";
