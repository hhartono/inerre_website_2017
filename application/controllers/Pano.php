...
class Pano extends CI_Controller
{
    ...
    public function alfred_project()
    {
        ...
        $data['rows'][1]['title'] = "ALFRED - LIVING, DINING, FOYER - 360 RENDERING";
        $data['rows'][1]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/alfredvtour2/tour.html";
        $data['rows'][1]['button_title'] = "see 360 rendering";

        $data['rows'][2]['title'] = "ALFRED - OFFICE - 360 RENDERING";
        $data['rows'][2]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/alfredvtour3/tour.html";
        $data['rows'][2]['button_title'] = "see 360 rendering";
    ...
    public function mjs_project()
    {
        $data['rows'][0]['title'] = "MJS - BEDROOM - 360 RENDERING";
        $data['rows'][0]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/mjsvtour/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";
    ...
    public function rwp_project()
    {
        ...
        $data['rows'][0]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/rwpvtour/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";

        $data['rows'][1]['title'] = "RWP - LIVING LT 2 - 360 RENDERING";
        $data['rows'][1]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/rwpvtour2/tour.html";
        $data['rows'][1]['button_title'] = "see 360 rendering";

        $data['rows'][2]['title'] = "RWP - FOYER & LIVING LT 1 - 360 RENDERING";
        $data['rows'][2]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/rwpvtour3/tour.html";
        $data['rows'][2]['button_title'] = "see 360 rendering";

        $data['rows'][3]['title'] = "RWP - PARENTS BEDROOM - 360 RENDERING";
        $data['rows'][3]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/rwpvtour4/tour.html";
        $data['rows'][3]['button_title'] = "see 360 rendering";

        $data['rows'][4]['title'] = "RWP - ENTERTAINMENT - 360 RENDERING";
        $data['rows'][4]['url'] = "http://" . $GLOBALS['inerre_vr_backup'] . "/rwpvtour5/tour.html";
        $data['rows'][4]['button_title'] = "see 360 rendering";
