...
class Pano extends CI_Controller {
    ...
    public function sumarko_project()
    {
        ...
        $data['rows'][1]['url'] = "http://18.139.219.177/pdf/sumarko/Sumarko_Presentation_25.10.2021.pdf";
        $data['rows'][1]['button_title'] = "see 360 rendering";
    ...
    {
        $data['rows'][0]['title'] = "SOHPIA - 360 RENDERING - PHASE 1";
        $data['rows'][0]['url'] = "http://18.139.219.177/sohpiavtour/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";

        $data['rows'][1]['title'] = "SOHPIA - PRESENTATION - PHASE 1";
