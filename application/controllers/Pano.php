...
class Pano extends CI_Controller {
    ...
    */
    ...
    {
        $data['rows'][0]['title'] = "WILLIAM - 360 RENDERING - PHASE 3";
        $data['rows'][0]['url'] = "http://18.139.219.177/williamvtour3/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";
    ...
    {
        $data['rows'][0]['title'] = "WILLIAM - 360 RENDERING - PHASE 4";
        $data['rows'][0]['url'] = "http://18.139.219.177/williamvtour4/tour.html";
        $data['rows'][0]['button_title'] = "see 360 rendering";
